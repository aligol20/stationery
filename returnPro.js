...
export default class ReturnPro extends Component {
...
<tr>
    ...
    getUserDetails() {
        ...
        fetch("http://koalafruit.ir/api/user_details_order_total.php", {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
            ...
            .then(responseJson => {
                ...
                console.log(kooni, "lazlazlazawwww");

                fetch("http://koalafruit.ir/api/preFactor_total.php", {
                    method: "POST",
                    headers: {
                        Accept: "application/json",
                        "Content-Type": "application/json"
    ...
    setMount() {
        ...
        let ytr = {
            mount: parseInt(this.state.set_mount)-parseInt(this.state.preSaledMount),
            name: this.props.name,
            phone: this.props.phone,
            proName: this.state.proName,
        ...
        let huh ={
            ...
            station_mount : parseInt(this.state.station_mount)-parseInt(this.state.set_mount)+parseInt(this.state.preSaledMount)

        };
        console.log(parseInt(this.state.set_mount), "s,csn,mscscs0");
        console.log(parseInt(this.state.preSaledMount), "s,csn,mscscs1");
        console.log(huh, "s,csn,mscscs7");
        console.log(ytr, "s,csn,mscscs2");
        console.log(this.state.proId,';sldfkdklfdf');
                // this.setState({ saledDialog: false });

        fetch("http://koalafruit.ir/api/set_mount_total.php", {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
            ...
            if (response.status === 200 && response.ok ) {
                ...
                fetch("http://koalafruit.ir/api/update_stationery_.php", {
                    method: "POST",
                    headers: {
                        Accept: "application/json",
                        "Content-Type": "application/json"
                    },
                    body: JSON.stringify(huh)
                }).then(response => {
                    console.log(response, huh, "dwlkfkdklfdkl67");
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        ...
                        >
                            ...
                            >
                                {item['SUM(order_price*saled_mount)'] + " " + "تومان"}
                            </Text>
                            ...
                            <TouchableHighlight
                                ...
                                onPress={() =>
                                    this.setState({ saledDialog: true,proId:item.order_id,station_mount:item.stationery_mount,station_id:item.stationery_id, proName: item.order_name,preSaledMount:item['SUM(saled_mount)'] })
                                }
                                style={{
                                    width: "16%",
